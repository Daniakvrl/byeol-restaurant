...
public class OrderController {
    ...
    public ResponseEntity<OrderResponse> getOrderByTrackingToken(@PathVariable String trackingToken){
        OrderResponse orderResponse = orderService.getOrderByTrackingToken(trackingToken);
        return ResponseEntity.status(HttpStatus.OK).body(orderResponse);
    }
